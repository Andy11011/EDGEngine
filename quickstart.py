...
print(account_report.to_string() if hasattr(account_report, "to_string") else account_report)
...
print(positions_report.to_string() if hasattr(positions_report, "to_string") else positions_report)
...
print(order_fills_report.to_string() if hasattr(order_fills_report, "to_string") else order_fills_report)
